...
import argparse
import sys
from generalization_in_diffusion_models.code.network_orig import *
from model_loader_func import initialize_network
from generalization_in_diffusion_models.code.trainer_orig import run_training
...
def prep_data_swap(train_coeffs,args, save):
    ...
    if save: 
        torch.save(train_set, args.dir_name + '/train_set_gmm_pca_5d.pt')
        torch.save(test_set, args.dir_name + '/test_set_gmm_pca_5d.pt')
...
def main():
    ...
    if args.debug:
        ...
        ### repeat train images 
        train_set  = repeat_images(train_set,args, N_total=20000) # N_total=1000000 for 40x40 images 
